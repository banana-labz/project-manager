...
export class DummyService implements BaseService {
  ...
  private projects: Project[] = [
    { id: 0, name: "Project #1", owner: 0, description: "It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout." },
    { id: 1, name: "Project #2", owner: 0, description: "If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text." },
    { id: 2, name: "Project #3", owner: 1, description: "Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of de Finibus Bonorum et Malorum (The Extremes of Good and Evil) by Cicero, written in 45 BC." },
    { id: 3, name: "Project #4", owner: 2, description: "Lorem Ipsum is simply dummy text of the printing and typesetting industry." },
    { id: 4, name: "Project #5 with larger name", owner: 3, description: "Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like)" },
  ]
